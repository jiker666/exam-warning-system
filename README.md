...
>
> ✅ **真实 AssemblyAI API 已验证（2026-09-21）**：16 秒中文语音 7.3 秒完成真实转录，完整链路（提交 WebM → ffmpeg → 真实转录 → 关键词评分 → 预警落库）端到端通过，证据见 [`docs/assemblyai-real-test.md`](docs/assemblyai-real-test.md)。
